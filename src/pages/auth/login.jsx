    ...
    <>
      ...
      <div className="w-full h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex justify-center items-center w-full h-screen">
          <div className="card-login bg-gray-300 rounded-xl shadow-sm shadow-slate-400 px-5 py-8 md:px-10 md:py-10">
            <form onSubmit={handleSubmit}>
              <p className="text-center text-3xl md:text-4xl font-bold">Login</p>
              <div className="flex flex-col mt-8 md:mt-10">
                <p className="text-jdl">Email</p>
                <input
                  className="w-full h-10 rounded-lg placeholder-gray-500 pl-3 mt-2"
                  type="email"
